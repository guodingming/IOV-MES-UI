			...
			<template slot="extra">
				<el-form label-width="40px">
					<el-form-item label="产品">
						<mes-cascader :data="cascaderData" ref="cascader" @level1="level1" @change="changeProduct">
						</mes-cascader>
					</el-form-item>
				</el-form>
			</template>
...
<script>
	...
	export default {
		...
		methods: {
			...
			treeDelete_getPage() {
				this.$.delete('此操作将永久删除该标签类型, 是否继续?', () => {
					treeDelete({
