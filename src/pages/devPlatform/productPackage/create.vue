<template>
  <!--新建包装箱-->
  <el-dialog title="新建包装箱" :visible.sync="show" size="small" id="createPackBox" :close-on-click-modal="false">
...
<style scoped>
  #createPackBox .el-textarea__inner{
  height:130px;
}
</style>
