...
#palletManager .el-form-item__label { padding: 11px 10px 11px 0; } #palletManager .el-tree-node__label { max-width: 150px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
