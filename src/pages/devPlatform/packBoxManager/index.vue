		 ...
		 <template slot="extra">
			...
			<div class="mes-content" slot="container">
				<div class="mes-tool">
					...
					<!--<el-button type="primary" @click="package_getPage" :disabled="!selectNode||(selectNode&&selectNode.isRoot)">产品包装<i class="el-icon-upload el-icon--right"></i>
          					</el-button>-->
