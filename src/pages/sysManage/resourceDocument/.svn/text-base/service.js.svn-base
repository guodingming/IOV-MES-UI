...
export const queryMaterial = (data) => fetch('/pdbommaterials/byCondition', data, "POST");
export const configMaterial = (data) => fetch('/pdfileresources/saveMaterialResourceFile', data, "POST");
export const queryResourceFileMaterials = (data) => fetch('/pdfileresources/getResourceFileMaterials', data, "GET");
