<template>
	<el-dialog title="编辑用户" :visible.sync="show" size="small" :close-on-click-modal="false">
	...
	export default {
		...
		methods: {
            ...
            trigger: 'change'
						...
						{
							validator: this.$.checkRepeat(queryUser, this.form.id, "username", "该用户名已存在"),
							trigger: 'change'
						}
					],
					mobilePhone: [{
						...
						{
							validator: this.$.checkRepeat(queryUser, this.form.id, "mobilePhone", "该手机号已存在"),
							trigger: 'change'
						}
					],
					email: [{
					...
					name: [{
						...
						{
							validator: this.$.checkRepeat(queryUser, this.form.id, "name", "该姓名已存在"),
							trigger: 'change'
						}
					],
					jobNumber: [{
						...
						{
							validator: this.$.checkRepeat(queryUser, this.form.id, "jobNumber", "该工号已存在"),
							trigger: 'change'
						}
					],
					phone: [{
